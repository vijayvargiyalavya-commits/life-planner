        ...
        <>
          ...
          >
            <div className="p-8 border-b border-slate-50 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-serif font-bold text-slate-900">Notifications</h2>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Status Updates</p>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex gap-4">
                        <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center shrink-0", colors[n.type])}>
                          <Icon className="w-5 h-5" />
                        </div>
                        <div className="flex-1">
                          <div className="flex justify-between items-start mb-1">
                            <h3 className={cn("text-sm font-bold", n.read ? "text-slate-600" : "text-slate-900")}>{n.title}</h3>
                      ...
                      {!n.read && (
                        <button 
                          ...
                          className="absolute bottom-2 right-2 p-2 opacity-0 group-hover:opacity-100 transition-opacity text-teal-600 hover:bg-teal-50 rounded-lg"
                        >
            ...
            {notifications.length > 0 && (
              <div className="p-6 border-t border-slate-50">
                <button 
                  onClick={onClearAll}
                  className="w-full py-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors"
                >
                  Clear All History
                </button>
              </div>
